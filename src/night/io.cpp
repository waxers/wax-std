...
void OStream::operator<<(short ostream) { printf("%i", ostream); }
void OStream::operator<<(unsigned short ostream) { printf("%i", ostream); }
void OStream::operator<<(long ostream) { printf("%ld", ostream); }
void OStream::operator<<(unsigned long ostream) { printf("%lu", ostream); }
